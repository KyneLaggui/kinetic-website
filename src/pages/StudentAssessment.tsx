...
import { Trophy, Timer, Target, Award, CircleChevronRight } from "lucide-react";
...
export default function GamifiedAssessmentDashboard() {
  ...
  useEffect(() => {
    if (quizResults.length > 0 || assessment4Results.length > 0) {
      ...
      combined.sort(
        (a, b) => Number(a.assessment_number) - Number(b.assessment_number)
      );
  ...
  const stats = useMemo(() => {
    ...
    const average =
      totalPossible > 0 ? (totalScore / totalPossible) * 50 + 50 : 0;
                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="flex flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3 sm:ml-auto">
                      ...
                      <a
                        href={`/student-breakdown/${encodeURIComponent(
                          assessment.title
                        )}/${userId}`}
